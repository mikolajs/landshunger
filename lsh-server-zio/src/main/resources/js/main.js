...
class Main {
 constructor(){
   ...
   this.app.loader.add(
        ...
        {"name":"a", "url":"img/swamp_120x72.png"},
        {"name":'c0', "url":"img/corn_120x72.png"},
        {"name":'ov', "url":"img/village.png"},
        {"name":'f4', "url":"img/forest_l.png"},
        {"name":'f3', "url":"img/forest_m.png"},
        {"name":'f2', "url":"img/forest_s.png"},
        {"name":'f1', "url":"img/forest_e.png"},
        {"name":'f0', "url":"img/forest_sb.png"},
        {"name":'og', "url":"img/mine_new_c.png"},
        {"name":'ow', "url":"img/grapes.png"},
        {"name":'ua', "url":"img/arkebusers.png"},
        {"name":'uc', "url":"img/cows.png"},
        {"name":'us', "url":"img/sheep.png"},

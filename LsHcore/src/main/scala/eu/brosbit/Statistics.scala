...
class Statistics(map:Array[Array[Tile]]){
  ...
  def countForests: Unit = {
    val woods = map.foldLeft(0)((n,a)=> n + a.foldLeft(0)((m, t) => {
      m + (if(t.imObjOpt.nonEmpty && t.imObjOpt.get.obj.shortName == "LW") 1 else 0)
    }))
  ...
  def countHPOfForest: Unit = {
    val wood = map.foldLeft(0)((n,a)=> n + a.foldLeft(0)((m, t) => {
      m + (if(t.imObjOpt.nonEmpty && t.imObjOpt.get.obj.shortName == "LW") t.imObjOpt.get.getHP() else 0)
    }))
  ...
  def countGrasses: Unit = {
    val grasses = map.foldLeft(0)((n,a)=> n + a.foldLeft(0)((m, t) => {
      m + (if(t.imObjOpt.nonEmpty && t.imObjOpt.get.obj.shortName == "GR") 1 else 0)
    }))
  ...
  def countHPOGrasses: Unit = {
    val wood = map.foldLeft(0)((n,a)=> n + a.foldLeft(0)((m, t) => {
      m + (if(t.imObjOpt.nonEmpty && t.imObjOpt.get.obj.shortName == "GR") t.imObjOpt.get.getHP() else 0)
    }))
